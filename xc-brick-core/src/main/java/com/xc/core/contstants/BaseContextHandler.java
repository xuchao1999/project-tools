...
public class BaseContextHandler {
    ...
    public static Long getUserId() {
        String value = get(BaseContextConstants.JWT_KEY_USER_ID);
    ...
    public static String getToken() {
        String value = get(BaseContextConstants.TOKEN_NAME);
        return value;
    }
    ...
    public static Long getOrgId() {
        String value = get(BaseContextConstants.JWT_KEY_ORG_ID);
        return Long.valueOf(value);
    }
    ...
    public static Long getStationId() {
        String value = get(BaseContextConstants.JWT_KEY_STATION_ID);
        return Long.valueOf(value);
    }
    ...
    public static String getDatabase() {
        String value = get(BaseContextConstants.DATABASE_NAME);
        return value;
    }
