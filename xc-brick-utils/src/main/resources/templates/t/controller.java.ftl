...
public class ${table.controllerName} {
    ...
    public  R<> list(@Valid @RequestBody ${entity} param) {
    ...
    public  R<Object> add(@Valid @RequestBody ${entity} param) {
    ...
    public  R<Object> modify(@Valid @RequestBody ${entity} param) {
    ...
    public  R<Object> removes(@Valid @RequestBody List<Long> ids) {
